...
pdf("results/Fig1_August2020.pdf", width = 7.204724, height = 7.204724*2/3)
...
## plot
pdf("results/Fig2_August2020.pdf", width = 7.204724, height = 7.204724*0.625)
...
pdf("results/ExtendedDataFig1_August2020.pdf", width = 7.204724, height = 7.204724)
